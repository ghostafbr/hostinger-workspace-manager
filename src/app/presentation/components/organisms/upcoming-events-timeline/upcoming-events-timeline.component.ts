...
@Component({
  ...
  styles: [
    `
      ...
      .card-header .header-title .icon-indicator i {
        font-size: 1.2rem;
      }
      ...
      ::ng-deep .custom-timeline .p-timeline-event-opposite {
        display: none;
      }
      ::ng-deep .custom-timeline .p-timeline-event-connector {
      ...
      .timeline-marker.marker-domain {
        background: #475569;
      }
      .timeline-marker.marker-subscription {
        background: #64748b;
      }
      .event-card {
        background: #ffffff;
