      ...
      <div class="checks-list">
        <p-accordion [multiple]="true" [value]="['critical', 'warnings']">
              ...
              <div *ngFor="let check of failures()" class="check-item fail mb-3 p-3 border-round">
                <div class="flex align-items-start gap-3">
                  ...
                  <div>
                    ...
                    <div
                      *ngIf="check.recommendation"
                      class="mt-2 text-sm text-700 bg-red-50 p-2 border-round inline-block"
                    >
              ...
              <div *ngFor="let check of warnings()" class="check-item warn mb-3 p-3 border-round">
                <div class="flex align-items-start gap-3">
                  ...
                  <div>
                    ...
                    <div
                      *ngIf="check.recommendation"
                      class="mt-2 text-sm text-700 bg-orange-50 p-2 border-round inline-block"
                    >
                      <i class="pi pi-info-circle mr-1"></i>
          ...
          <p-accordion-panel value="passed" *ngIf="passes().length > 0">
            ...
            <p-accordion-content>
              <div
                *ngFor="let check of passes()"
                class="check-item pass mb-2 p-2 px-3 border-round flex align-items-center gap-2"
              >
...
export class DnsValidationComponent {
  ...
  getHealthColorClass(): string {
    ...
    switch (result.status) {
      case DnsValidationStatus.HEALTHY:
        return 'success';
      case DnsValidationStatus.WARNINGS:
        return 'warning';
      case DnsValidationStatus.ERRORS:
        return 'error';
      default:
        return '';
    }
